...
class SearchEngine{
    ...
    function __construct(){
        $this->accessKey = $_ENV['SEARCHENGINE_ACCESS_KEY'];
        $this->secretKey = $_ENV['SEARCHENGINE_SECRET_KEY'];
        $this->url = $_ENV['SEARCHENGINE_URL'];
        $this->index_name = $_ENV['SEARCHENGINE_INDEX'];
    ...
    */
    ...
    function convertSearchEngineArrayToProduct($searchengineResults){
      ...
      foreach($searchengineResults as $hit){
          ...
          $prod->name = $hit["_source"]["title"]; // title -> name
          $prod->description = $hit["_source"]["description"];
          $prod->price = $hit["_source"]["price"];
          $prod->popularityFactor = $hit["_source"]["popularityFactor"] ?? null;
          $prod->category_id = $hit["_source"]["categoryid"] ?? null; // categoryid -> category_id
          $prod->color = $hit["_source"]["color"] ?? null;
          $prod->image_url = $hit["_source"]["image_url"] ?? null;
